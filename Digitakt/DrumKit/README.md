...
1. Choose the kick (Track 1)
	...
	- Tune it so it fits your song.
	- Use the filter to remove unnecessary high frequencies.
	- Adjust the amp envelope so it's as short or long as needed.
1. Choose the snare (Track 2)
